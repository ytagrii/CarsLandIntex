...
namespace CarsLandIntex.Infastructure
{

    [HtmlTargetElement("div", Attributes = "crash-page")]
    public class PagnationTagHelper : TagHelper
    {
        ...
        public PageInfo CrashPage { get; set; } //this has to be named the same as the Attributes thing up above.
